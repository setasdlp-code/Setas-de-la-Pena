...
// source-hash: 25dc513e85096e25b19710d86a42a2df540c91d40b784088a3bc2d8aa08c1b79
...
`;
  ...
  })(), tab === "catalogo" && /* @__PURE__ */ React.createElement("div", { className: "spp-sect spp-sect-catalog" }, /* @__PURE__ */ React.createElement("div", { className: "catalog-hdr" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "catalog-eyebrow" }, "Receta"), /* @__PURE__ */ React.createElement("h1", { className: "catalog-title" }, "Catálogo de especies"))), /* @__PURE__ */ React.createElement("div", { className: "spp-grid" }, Object.entries(SPP).map(([k, d], idx) => {
    const hasImg = !!IMG[k];
    const isOn = sKey === k;
...
Click para ver análisis completo`
  ...
  })()), tab === "inventario" && BodegaSection(), tab === "dashboard" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "panel" }, saved.length > 0 && (() => {
