...
// source-hash: ab9a77bb0c425a53acf48b072bc9afe006ffeafccd214503689c5e4affa30b43
...
`;
  ...
  )), coFormMode && /* @__PURE__ */ React.createElement("section", { id: "co-form-panel", className: "co-form-panel", "data-testid": "co-form-panel", "aria-labelledby": "formular-coform-toggle", style: { margin: "10px 0", padding: "12px", background: "var(--surface-card,#fbf9f4)", borderRadius: "8px", border: "1px solid var(--border-subtle,#e2dacd)" } }, /* @__PURE__ */ React.createElement("header", { style: { display: "flex", justify: "space-between", alignItems: "center", marginBottom: "8px" } }, /* @__PURE__ */ React.createElement("strong", { style: { fontSize: "0.9rem" } }, "🧬 Co-Formulación Multi-Especie (Ponderación de Lote)"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: "0.8rem", color: "var(--ink-600,#666)" } }, "Proporción de producción por especie")), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "10px" } }, Object.entries(SPP).map(([k, d]) => {
