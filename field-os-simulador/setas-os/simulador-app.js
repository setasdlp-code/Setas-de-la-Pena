...
// source-hash: df86dc6a04d21db226954f8944c76092195008e56d3e02d0347fae468016dff2
...
`;
  ...
  })()), tab === "formular" && /* @__PURE__ */ React.createElement("div", { className: "builder-wrap", "data-tab": tab }, loadedFlash && /* @__PURE__ */ React.createElement("div", { className: "loaded-toast" }, "✓ Receta cargada"), /* @__PURE__ */ React.createElement("section", { className: "form-flow", "aria-labelledby": "form-flow-title" }, /* @__PURE__ */ React.createElement("div", { className: "form-flow-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "form-flow-eyebrow" }, "Nueva formulación"), /* @__PURE__ */ React.createElement("h2", { id: "form-flow-title" }, "Especie → Origen → Ingredientes → Validar y guardar")), /* @__PURE__ */ React.createElement("span", { className: "form-flow-progress", "aria-live": "polite" }, recipe.length > 0 ? `${recipe.length} ingrediente${recipe.length === 1 ? "" : "s"} · Perito ${Math.round(opt.score)}/100` : "Preparado para comenzar")), /* @__PURE__ */ React.createElement("ol", { className: "form-flow-grid" }, /* @__PURE__ */ React.createElement("li", { className: "form-step is-ready" }, /* @__PURE__ */ React.createElement("span", { className: "form-step-num" }, "01"), /* @__PURE__ */ React.createElement("label", { className: "form-step-label", htmlFor: "form-species" }, "Especie"), /* @__PURE__ */ React.createElement("select", { id: "form-species", name: "formSpecies", value: hasPickedSpecies ? sKey : "", onChange: (e) => e.target.value && setSKey(e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "", disabled: true }, "Elegir especie…"), Object.entries(SPP).map(([k, d]) => /* @__PURE__ */ React.createElement("option", { key: k, value: k }, d.name))), /* @__PURE__ */ React.createElement("span", { className: "form-step-help" }, "Define los rangos C:N, pH y EB.")), /* @__PURE__ */ React.createElement("li", { className: "form-step is-ready" }, /* @__PURE__ */ React.createElement("span", { className: "form-step-num" }, "02"), /* @__PURE__ */ React.createElement("span", { className: "form-step-label" }, "Origen"), /* @__PURE__ */ React.createElement("div", { className: "form-step-options", role: "group", "aria-label": "Origen de ingredientes" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: globalMode === "produccion" ? "is-active" : "", "aria-pressed": globalMode === "produccion", onClick: () => setGlobalWorkMode("produccion") }, "Solo bodega"), /* @__PURE__ */ React.createElement("button", { type: "button", className: globalMode === "investigacion" ? "is-active" : "", "aria-pressed": globalMode === "investigacion", onClick: () => setGlobalWorkMode("investigacion") }, "Paleta completa")), /* @__PURE__ */ React.createElement("span", { className: "form-step-help" }, globalMode === "produccion" ? "Usa únicamente el stock disponible." : "Permite explorar todo el catálogo.")), /* @__PURE__ */ React.createElement("li", { className: `form-step${hasPickedSpecies ? " is-ready" : ""}` }, /* @__PURE__ */ React.createElement("span", { className: "form-step-num" }, "03"), /* @__PURE__ */ React.createElement("span", { className: "form-step-label" }, "Ingredientes"), /* @__PURE__ */ React.createElement("div", { className: "form-step-actions" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => document.getElementById("bl-ingredientes")?.scrollIntoView({ behavior: "smooth", block: "start" }) }, "Elegir manualmente"), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => document.getElementById("gen-panel")?.scrollIntoView({ behavior: "smooth", block: "start" }) }, "Usar generador")), /* @__PURE__ */ React.createElement("span", { className: "form-step-help" }, "Agrega insumos o calcula una base.")), /* @__PURE__ */ React.createElement("li", { className: `form-step${recipe.length > 0 ? " is-ready" : ""}` }, /* @__PURE__ */ React.createElement("span", { className: "form-step-num" }, "04"), /* @__PURE__ */ React.createElement("span", { className: "form-step-label" }, "Validar y guardar"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "form-step-primary", disabled: recipe.length === 0, onClick: () => document.getElementById("bl-receta")?.scrollIntoView({ behavior: "smooth", block: "start" }) }, recipe.length > 0 ? "Revisar receta" : "Agrega ingredientes"), /* @__PURE__ */ React.createElement("span", { className: "form-step-help" }, "Revisa balance, riesgo, costo y tratamiento.")))), /* @__PURE__ */ React.createElement("div", { className: "sim-live-dashboard", id: "sim-live-dash" }, recipe.length > 0 ? (() => {
...
Click para editar`
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "bodega-bar-right" }, /* @__PURE__ */ React.createElement("button", { className: "bodega-bar-refresh", onClick: (e) => {
    e.stopPropagation();
    goTab("inventario");
    ...
    return ROLE_GROUPS.map((grp) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: grp.key, className: "role-group-box", style: { marginBottom: 10, border: "1px solid var(--border-soft)", borderRadius: "var(--r-xs)", background: "var(--paper-50)", overflow: "hidden" } }, /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", background: "rgba(77,98,53,.12)", color: "var(--moss-700)", padding: "2px 5px", borderRadius: 3, fontWeight: 600 } }, compatCount, " compatible", compatCount === 1 ? "" : "s"), /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: { fontSize: "var(--text-xs)", color: "var(--ink-500)", transform: isCollapsed ? "rotate(-90deg)" : "rotate(0deg)", transition: "transform .15s" } }, "▼"))
