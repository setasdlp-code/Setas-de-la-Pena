...
// source-hash: c2a32d664d2bc84f3e79bcb5b8a78f27f80e31a0876a9053f537c71d6a6e4231
...
`;
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "topbar" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "topbar-mark", onClick: () => goTab("catalogo"), style: { cursor: "pointer", display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("img", { src: "_standalone_imgs/logo-sdlp.png", alt: "Setas de la Peña", width: "28", height: "28", style: { width: 28, height: "auto", objectFit: "contain" } }), /* @__PURE__ */ React.createElement("span", null, "Setas de la Peña"))), /* @__PURE__ */ React.createElement("nav", { className: "fos-rail" }, /* @__PURE__ */ React.createElement("span", { className: "fos-rail-mark", style: { position: "relative", width: 91, display: "flex", alignItems: "center", justifyContent: "center", padding: "12px 6px 8px" } }, /* @__PURE__ */ React.createElement("img", { src: "_standalone_imgs/logo-sdlp.png", alt: "Setas de la Peña", width: "76", height: "76", style: { width: 76, height: "auto", maxHeight: 76, objectFit: "contain", display: "block" } })), NAV_GROUPS.map((g) => {
    ...
    const operationStatus = criticalTaskCount > 0 ? { label: `${criticalTaskCount} crítica${criticalTaskCount === 1 ? "" : "s"}`, color: "color-mix(in oklab, var(--coral-700) 70%, black)", bg: "color-mix(in oklab, var(--coral-500) 12%, var(--paper-0))" } : overdueTaskCount > 0 || incidentCount > 0 ? { label: `${overdueTaskCount + incidentCount} pendiente${overdueTaskCount + incidentCount === 1 ? "" : "s"}`, color: "color-mix(in oklab, var(--ochre-700) 70%, black)", bg: "color-mix(in oklab, var(--ochre-500) 12%, var(--paper-0))" } : { label: "Operación estable", color: "color-mix(in oklab, var(--moss-700) 75%, black)", bg: "color-mix(in oklab, var(--moss-700) 10%, var(--paper-0))" };
    let camaras = [];
    try {
