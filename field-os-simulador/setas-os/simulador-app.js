...
`;
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "topbar" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "topbar-mark", onClick: () => goTab("catalogo"), style: { cursor: "pointer", display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("img", { src: "_standalone_imgs/logo-sdlp.png", alt: "Setas de la Peña", width: "54", height: "28", style: { width: 54, height: "auto", maxHeight: 28, objectFit: "contain" } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 15, fontWeight: 700 } }, "Setas de la Peña"))), /* @__PURE__ */ React.createElement("nav", { className: "fos-rail" }, /* @__PURE__ */ React.createElement("span", { className: "fos-rail-mark", style: { position: "relative", width: 91, display: "flex", alignItems: "center", justifyContent: "center", padding: "12px 4px 8px" } }, /* @__PURE__ */ React.createElement("img", { src: "_standalone_imgs/logo-sdlp.png", alt: "Setas de la Peña", width: "80", height: "42", style: { width: 80, height: "auto", maxHeight: 48, objectFit: "contain", display: "block" } })), NAV_GROUPS.map((g) => {
    ...
    }))), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper-0)", border: "1px solid var(--border-soft)", borderRadius: 0, padding: "18px 20px", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", boxShadow: "none" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12, flexWrap: "wrap", gap: 8 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", fontWeight: 700, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: "var(--ink-2)" } }, "SECCIÓN A · TRABAJO DEL DÍA"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-serif)", fontWeight: 700, fontSize: "var(--text-xl)", letterSpacing: "-0.01em", color: "var(--ink-0)", marginTop: 2, marginBottom: 0 } }, "Tareas de Hoy")), tasksHoy.length > 0 && /* @__PURE__ */ React.createElement("span", { "data-testid": "cockpit-task-count", style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--ink-2)" } }, (() => {
      const n = tasksHoy.some((t) => t.fromEngine) ? tasksHoy.filter((t) => !t.done).length : props.tasksOpenCount || tasksHoy.length;
      return `${n} pendiente${n === 1 ? "" : "s"}`;
    })())), tasksHoy.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "20px", color: "var(--ink-2)", fontFamily: "var(--font-sans)", fontSize: "var(--text-xs)", border: "1px dashed var(--line-0)", borderRadius: 0 } }, "Sin tareas pendientes por ahora.") : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, tasksHoy.slice(0, 5).map((t) => /* @__PURE__ */ React.createElement("div", { key: t.key, style: { display: "flex", alignItems: "center", gap: 2, padding: "4px 12px 4px 4px", border: "1px solid var(--line-0)", borderRadius: 0, opacity: t.done ? 0.5 : 1 } }, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => t.fromEngine ? closeTaskFromCheckbox(t) : props.onTaskToggle && props.onTaskToggle(t.key),
        "aria-pressed": t.done,
        "aria-label": `Marcar tarea: ${t.title}`,
...
Click para ver análisis completo`
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      )), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, "data-testid": "qr-contextual-actions" }, currentSheet && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: ".08em", textTransform: "uppercase", color: "var(--ink-2)" } }, "Acciones válidas en ", currentSheet.stateLabel.toLowerCase()), (currentSheet ? currentSheet.actions : [{ action: "harvest", label: "Registrar cosecha", blockedBy: null }, { action: "contamination", label: "Reportar contaminación", blockedBy: null }]).map((a, i) => /* @__PURE__ */ React.createElement(
        "button",
        {
          key: a.action,
          type: "button",
