...
// source-hash: d4beb7b05a9eff6adf0a64b0a8ed945eb04354ed430a5b228f4f625b49bdf5f6
...
`;
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "topbar" }, /* @__PURE__ */ React.createElement("div", { className: "topbar-mark", onClick: () => goTab("catalogo"), style: { cursor: "pointer" } }, "Setas de la Peña")), /* @__PURE__ */ React.createElement("nav", { className: "fos-rail" }, /* @__PURE__ */ React.createElement("span", { className: "fos-rail-mark", style: { position: "relative", width: 91, height: 106, display: "block" } }, /* @__PURE__ */ React.createElement("span", { style: { textAlign: "center", fontStyle: "normal", fontSize: 17, display: "block" } }, "Setas"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "var(--text-md)", lineHeight: 0.95, position: "absolute", left: 30, top: 49, fontStyle: "italic", letterSpacing: "-0.1px" } }, "de la"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, lineHeight: 1, position: "absolute", left: 27, top: 65 } }, "Peña")), NAV_GROUPS.map((g) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "home-cockpit", style: { display: "flex", flexDirection: "column", gap: 24, marginBottom: 48 } }, /* @__PURE__ */ React.createElement("div", { style: {
      ...
      }))), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper-0)", border: "1px solid var(--border-soft)", borderRadius: "var(--r-md)", padding: "18px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12, flexWrap: "wrap", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", fontWeight: 700, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: "var(--ink-500)" } }, "Tareas de hoy"), tasksHoy.length > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--ink-400)" } }, props.tasksOpenCount)), tasksHoy.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "20px", color: "var(--ink-500)", fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", border: "1px dashed var(--paper-300)", borderRadius: "var(--r-sm)" } }, "Sin tareas pendientes por ahora.") : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, tasksHoy.slice(0, 5).map((t) => /* @__PURE__ */ React.createElement("div", { key: t.key, style: { display: "flex", alignItems: "center", gap: 2, padding: "4px 12px 4px 4px", border: "1px solid var(--paper-300)", borderRadius: "var(--r-sm)", opacity: t.done ? 0.5 : 1 } }, /* @__PURE__ */ React.createElement(
        "button",
        {
