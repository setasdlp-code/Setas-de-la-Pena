...
// source-hash: f29fd27cda31806b90e5e5d8971f6150b5574bd28f7b0a9d3b57295aaf5e59d8
...
const CompositionChart = ({ recipe }) => {
  if (!recipe || !recipe.length) return null;
  const ROLE_LABELS2 = { base_carbono: "Base C", suplemento_n: "Supl. N", suplemento_medio: "Supl. Medio", aireador: "Aireador", aditivo_ph: "pH", aditivo_estructura: "Estructura", aditivo_micronutriente: "Micronut.", aditivo_arrancador: "Arrancador" };
  const ROLE_COLORS2 = { base_carbono: "#5A7042", suplemento_n: "#C68F2C", suplemento_medio: "#D4A838", aireador: "#4E7A6A", aditivo_ph: "#8B5C28", aditivo_estructura: "#7A6B58", aditivo_micronutriente: "#2A6A7A", aditivo_arrancador: "#9B4F3A" };
  const groups = {};
  recipe.forEach((r) => {
    const g = INGS.find((i) => i.id === r.id);
    if (!g) return;
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 16, padding: "14px 16px", background: "var(--paper-100)", border: "1px solid var(--border-soft)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", letterSpacing: "var(--tracking-wide)", textTransform: "uppercase", color: "var(--ink-500)", marginBottom: 10 } }, "Composición por función"), /* @__PURE__ */ React.createElement("div", { style: { height: 18, display: "flex", borderRadius: 2, overflow: "hidden", border: "1px solid rgba(0,0,0,.07)", marginBottom: 10 } }, entries.map(([role, val], i) => /* @__PURE__ */ React.createElement(
    ...
    {
      key: i,
      title: `${ROLE_LABELS2[role] || role}: ${val.toFixed(1)}%`,
      style: { width: `${val / total * 100}%`, background: ROLE_COLORS2[role] || "var(--ink-2)", transition: "width .4s" }
    }
  ))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: "4px 14px" } }, entries.map(([role, val], i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", alignItems: "center", gap: 5 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 9, height: 9, background: ROLE_COLORS2[role] || "var(--ink-2)", flexShrink: 0, border: "1px solid rgba(0,0,0,.1)" } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-sm)", color: "var(--ink-700)", fontWeight: 500 } }, ROLE_LABELS2[role] || role, " ", /* @__PURE__ */ React.createElement("strong", { style: { color: "var(--ink-900)" } }, val.toFixed(1), "%"))))));
};
...
Click para editar`
    ...
    })(), an.trichoderma && /* @__PURE__ */ React.createElement("div", { style: { color: "#C53030", fontWeight: 700, marginTop: 2 } }, "Autoclave 121°C × 90 min obligatorio"), !an.trichoderma && tr && /* @__PURE__ */ React.createElement("div", { style: { opacity: 0.6, marginTop: 2 } }, "Trat.: ", tr.name))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4, flexShrink: 0 } }, (criticals.length > 0 || warnings.length > 0) && /* @__PURE__ */ React.createElement("button", { onClick: autoImprove, style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", fontWeight: 700, padding: "6px 10px", background: "var(--coral-500)", color: "var(--paper-0)", border: "none", borderRadius: "var(--r-sm)", cursor: "pointer", whiteSpace: "nowrap" } }, "✦ Auto-mejorar"), recipeHistory.length > 0 && /* @__PURE__ */ React.createElement("button", { onClick: undoLastRec, style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", fontWeight: 700, padding: "6px 10px", background: "transparent", color: "var(--ink-600)", border: "1px solid var(--border-soft)", borderRadius: "var(--r-sm)", cursor: "pointer", display: "flex", alignItems: "center", gap: 4 } }, /* @__PURE__ */ React.createElement("svg", { width: "10", height: "10", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M3 7v6h6" }), /* @__PURE__ */ React.createElement("path", { d: "M3 13C5.5 7 12 4 18 7a9 9 0 010 10" })), "Deshacer (", recipeHistory.length, ")"), /* @__PURE__ */ React.createElement("button", { onClick: () => goTab("produccion"), style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", fontWeight: 700, padding: "6px 10px", background: "var(--moss-600,var(--accent-olive))", color: "var(--paper-0)", border: "none", borderRadius: "var(--r-sm)", cursor: "pointer", whiteSpace: "nowrap" } }, "Producir"), (status === "needs_work" || status === "critical") && /* @__PURE__ */ React.createElement("button", { onClick: () => {
    ...
    }, "aria-label": `Quitar ${g?.name || "ingrediente"} de la receta`, style: { flexShrink: 0, fontSize: "var(--text-base)", padding: "4px 8px" } }, "✕")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, /* @__PURE__ */ React.createElement("input", { type: "range", min: "0", max: "100", step: ".5", value: r.p, onChange: (e) => !isLocked && updP(r.id, parseFloat(e.target.value) || 0), disabled: isLocked, "aria-label": `Porcentaje de ${g.name}`, "aria-valuetext": `${r.p}%`, "aria-disabled": isLocked, style: { opacity: isLocked ? 0.5 : 1, width: "100%" } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("input", { type: "number", min: "0", max: "100", step: ".5", value: r.p, onChange: (e) => !isLocked && updP(r.id, parseFloat(e.target.value) || 0), readOnly: isLocked, className: "rec-pct-input", style: { width: "70px", padding: "6px 8px", border: "1px solid var(--paper-300)", background: isLocked ? "var(--paper-200)" : "var(--paper-100)", fontFamily: "var(--font-mono)", fontSize: "var(--text-sm)", textAlign: "center", color: "var(--ink-900)", outline: "none", borderRadius: "var(--r-xs)" } }), /* @__PURE__ */ React.createElement("span", { className: "pct", style: { fontSize: "var(--text-sm)", fontWeight: 600, color: "var(--ink-600)" } }, "%"))));
