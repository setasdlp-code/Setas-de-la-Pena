...
// source-hash: 59289211c8e74d3d02f255045028aa1772b3d1cda080db9e2373225bc24ade31
...
Click para editar`
    ...
    e.stopPropagation();
    goTab("catalogo");
  }, style: { fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-xs)", letterSpacing: "var(--tracking-button)", textTransform: "uppercase", padding: "6px 12px", background: "var(--accent-terracotta)", color: "#fff", border: "1px solid var(--accent-terracotta)", cursor: "pointer", transition: "background-color .15s,border-color .15s,color .15s,transform .15s", whiteSpace: "nowrap", flexShrink: 0 } }, "Ver catálogo"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--paper-0)", opacity: 0.6, fontSize: "var(--text-sm)", lineHeight: 1, transform: bridgeOpen ? "rotate(0deg)" : "rotate(180deg)", transition: "transform .15s" } }, "▾"))))));
}
