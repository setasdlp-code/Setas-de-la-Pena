...
const INGS = [
  ...
  { id: "pulpa_cafe", name: "Pulpa de café", cat: "cafe", cn: 25, n: 2.5, c: 45, moisture: 70, cra: 4, ph: 5.5, dig: 6, role: "suplemento_n", tags: ["Café", "N alto"], cost: 2500, cs: ["p_ostreatus_gris", "p_djamor_rosa"], notes: "Pendiente de verificar: literatura reporta C:N=18.1–21.0 para pulpa de café en compost YA MEZCLADO con estiércol de cabra (ve.scielo.org S1316-33612009000200004), no para pulpa fresca sola — no se ajustó cn=25 aquí porque la fuente mide un material distinto (compost, no pulpa fresca); confirmar con análisis propio antes de bajar el valor." },
  // === SUPLEMENTOS N ===
