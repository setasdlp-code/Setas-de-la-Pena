...
// source-hash: f14cb59e9b3f4b125e409e5ca2dd990c5839e5c4a843128b5e88fdab9d04fa24
...
`;
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "topbar" }, /* @__PURE__ */ React.createElement("div", { className: "topbar-mark", onClick: () => goTab("catalogo"), style: { cursor: "pointer" } }, "Setas de la Peña")), /* @__PURE__ */ React.createElement("nav", { className: "fos-rail" }, /* @__PURE__ */ React.createElement("span", { className: "fos-rail-mark", style: { position: "relative", width: 91, height: 106, display: "block" } }, /* @__PURE__ */ React.createElement("span", { style: { textAlign: "center", fontStyle: "normal", fontSize: 17, display: "block" } }, "Setas"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "var(--text-md)", lineHeight: 0.95, position: "absolute", left: 30, top: 49, fontStyle: "italic", letterSpacing: "-0.1px" } }, "de la"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, lineHeight: 1, position: "absolute", left: 27, top: 65 } }, "Peña")), NAV_GROUPS.map((g) => {
    ...
    const genSpark = (seedStr, mid, amplitude) => {
      ...
      const wave = (n) => Math.sin(seed * 0.013 + n) * 0.62 + Math.sin(seed * 0.031 + n * 2.7) * 0.28 + Math.sin(seed * 0.057 + n * 5.1) * 0.1;
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "home-cockpit", style: { display: "flex", flexDirection: "column", gap: 24, marginBottom: 48 } }, /* @__PURE__ */ React.createElement("div", { className: "home-header-row" }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    }), /* @__PURE__ */ React.createElement("span", { role: "status", "aria-label": `Estado operativo: ${operationStatus.label}`, style: { fontFamily: "var(--font-mono)", fontWeight: 700, fontSize: "var(--text-xs)", padding: "6px 10px", background: "var(--paper-50)", border: `1px solid ${operationStatus.color}`, borderRadius: "var(--r-xs)", color: operationStatus.color } }, operationStatus.label))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, flexWrap: "wrap", marginTop: 16, paddingTop: 16, borderTop: "1px solid var(--paper-300)" } }, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper-0)", border: "1px solid var(--border-soft)", borderRadius: "var(--r-md)", padding: "18px 20px" } }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-lg)", letterSpacing: "-0.01em", color: "var(--ink-900)", margin: 0 } }, "Actividad reciente"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", marginTop: 10 } }, recentActivity.map((ev, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 12, padding: "11px 0", borderBottom: "1px solid var(--paper-300)" } }, /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, width: 8, height: 8, borderRadius: "50%", background: ev.accent, marginTop: 6 } }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-body)", fontWeight: 700, fontSize: "var(--text-sm)", color: "var(--ink-900)" } }, ev.typeLabel), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--slate-600)" } }, ev.container)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", color: "var(--ink-600)", marginTop: 1 } }, ev.note))))));
    })()), (() => {
      let tasksHoy = [];
      try {
      ...
      )))), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper-0)", border: "1px solid var(--border-soft)", borderRadius: "var(--r-md)", padding: "18px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12, flexWrap: "wrap", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", fontWeight: 700, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: "var(--ink-500)" } }, "Registro de cultivo · vista previa"), /* @__PURE__ */ React.createElement("button", { onClick: () => props.onGoRegistro && props.onGoRegistro(), style: { cursor: "pointer", background: "none", border: "none", padding: 0, fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", fontWeight: 700, color: "var(--coral-600)" } }, "Ver registro completo →")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, overflowX: "auto", paddingBottom: 2 } }, [
      ...
      ].map((m) => /* @__PURE__ */ React.createElement("button", { key: m.label, onClick: () => m.onClick && m.onClick(), style: { cursor: "pointer", flex: "1 0 100px", minWidth: 100, textAlign: "left", background: "var(--paper-50)", border: "1px solid var(--paper-300)", borderRadius: "var(--r-xs)", padding: "12px 14px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-mono)", fontWeight: 700, fontSize: "var(--text-lg)", color: m.color || "var(--ink-900)" } }, m.value), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", color: "var(--ink-500)" } }, m.label)))))), hasTasksHoy && /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper-0)", border: "1px solid var(--border-soft)", borderRadius: "var(--r-md)", padding: "18px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-lg)", letterSpacing: "-0.01em", color: "var(--ink-900)", margin: 0 } }, "Tareas de hoy"), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--ink-400)" } }, props.tasksOpenCount)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, tasksHoy.map((t) => /* @__PURE__ */ React.createElement("div", { key: t.key, style: { display: "flex", alignItems: "center", gap: 2, padding: "4px 12px 4px 4px", border: "1px solid var(--paper-300)", borderRadius: "var(--r-sm)", opacity: t.done ? 0.5 : 1 } }, /* @__PURE__ */ React.createElement(
        "button",
        {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        spark && /* @__PURE__ */ React.createElement("div", { style: { borderTop: "1px solid var(--paper-300)", paddingTop: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", color: "var(--ink-500)", textTransform: "uppercase", letterSpacing: "var(--tracking-button)" } }, "Tendencia"), /* @__PURE__ */ React.createElement("button", { onClick: () => props.onGoCamaras && props.onGoCamaras(), style: { display: "flex", alignItems: "center", gap: 4, background: "none", border: "none", padding: 0, cursor: "pointer", fontFamily: "var(--font-body)", fontSize: "var(--text-2xs)", color: "var(--coral-600)", fontWeight: 700 } }, /* @__PURE__ */ React.createElement(IconCamera, { size: 11 }), " Cámaras →")), /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 280 40", preserveAspectRatio: "none", role: "img", "aria-label": `Tendencia últimas horas en ${s.nombre}: temperatura, humedad y CO₂`, style: { width: "100%", height: 36, overflow: "visible", display: "block" } }, /* @__PURE__ */ React.createElement("polyline", { points: spark.temp.d, fill: "none", stroke: "var(--coral-500)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }), /* @__PURE__ */ React.createElement("polyline", { points: spark.hum.d, fill: "none", stroke: "var(--slate-500)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }), /* @__PURE__ */ React.createElement("polyline", { points: spark.co2.d, fill: "none", stroke: "var(--moss-500)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }), /* @__PURE__ */ React.createElement("circle", { cx: 280, cy: spark.temp.endY, r: "3", fill: "var(--coral-500)" }), /* @__PURE__ */ React.createElement("circle", { cx: 280, cy: spark.hum.endY, r: "3", fill: "var(--slate-500)" }), /* @__PURE__ */ React.createElement("circle", { cx: 280, cy: spark.co2.endY, r: "3", fill: "var(--moss-500)" })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, marginTop: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 4, fontFamily: "var(--font-body)", fontSize: "var(--text-2xs)", color: "var(--ink-500)" } }, /* @__PURE__ */ React.createElement("span", { style: { width: 9, height: 2, background: "var(--coral-500)", display: "inline-block" } }), "Temp."), /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 4, fontFamily: "var(--font-body)", fontSize: "var(--text-2xs)", color: "var(--ink-500)" } }, /* @__PURE__ */ React.createElement("span", { style: { width: 9, height: 2, background: "var(--slate-500)", display: "inline-block" } }), "Humedad"), /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 4, fontFamily: "var(--font-body)", fontSize: "var(--text-2xs)", color: "var(--ink-500)" } }, /* @__PURE__ */ React.createElement("span", { style: { width: 9, height: 2, background: "var(--moss-500)", display: "inline-block" } }), "CO₂")))
      );
...
Click para editar`
    ...
    }, "aria-label": `Quitar ${g?.name || "ingrediente"} de la receta`, style: { flexShrink: 0, fontSize: "var(--text-base)", padding: "4px 8px" } }, "✕")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, /* @__PURE__ */ React.createElement("input", { type: "range", min: "0", max: "100", step: ".5", value: r.p, onChange: (e) => !isLocked && updP(r.id, parseFloat(e.target.value) || 0), disabled: isLocked, "aria-label": `Porcentaje de ${g.name}`, "aria-valuetext": `${r.p}%`, "aria-disabled": isLocked, style: { opacity: isLocked ? 0.5 : 1, width: "100%" } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("input", { type: "number", min: "0", max: "100", step: ".5", required: true, value: r.p, onChange: (e) => !isLocked && updP(r.id, parseFloat(e.target.value) || 0), readOnly: isLocked, "aria-label": `Porcentaje de ${g?.name || "ingrediente"} (numérico)`, className: "rec-pct-input", style: { width: "70px", padding: "6px 8px", border: "1px solid var(--paper-300)", background: isLocked ? "var(--paper-200)" : "var(--paper-100)", fontFamily: "var(--font-mono)", fontSize: "var(--text-sm)", textAlign: "center", color: "var(--ink-900)", outline: "none", borderRadius: "var(--r-xs)" } }), /* @__PURE__ */ React.createElement("span", { className: "pct", style: { fontSize: "var(--text-sm)", fontWeight: 600, color: "var(--ink-600)" } }, "%"))));
