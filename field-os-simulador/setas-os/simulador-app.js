...
// source-hash: bef2ca86f7ef246f020a9303e83fb8c4484965d56cc34ba27602f2f83a6f6f93
...
} }, /* @__PURE__ */ React.createElement("div", { className: "inv-modal", role: "dialog", "aria-modal": "true", "aria-label": dlg.title || "Confirmar", style: { width: 420 } }, /* @__PURE__ */ React.createElement("div", { className: "inv-modal-title" }, dlg.title || "Confirmar"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-sm)", color: "var(--ink-700)", marginBottom: 18, lineHeight: 1.5 } }, dlg.msg), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, justifyContent: "flex-end" } }, /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "inv-btn inv-btn-sec" }, "Cancelar"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
  dlg.onConfirm();
  onClose();
...
const PromptModal = ({ dlg, onClose }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "inv-modal-bg", onClick: (e) => {
    if (e.target === e.currentTarget) onClose();
  } }, /* @__PURE__ */ React.createElement("div", { className: "inv-modal", role: "dialog", "aria-modal": "true", "aria-label": dlg.title || "Nombre", style: { width: 420 } }, /* @__PURE__ */ React.createElement("div", { className: "inv-modal-title" }, dlg.title || "Nombre"), dlg.label && /* @__PURE__ */ React.createElement("label", { className: "inv-label", htmlFor: "setas-prompt-input" }, dlg.label), /* @__PURE__ */ React.createElement("input", { id: "setas-prompt-input", name: "promptValue", className: "inv-input", value: val, placeholder: dlg.placeholder || "", autoComplete: "off", onChange: (e) => setVal(e.target.value), onKeyDown: (e) => e.key === "Enter" && submit(), style: { marginBottom: 18 } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, justifyContent: "flex-end" } }, /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "inv-btn inv-btn-sec" }, "Cancelar"), /* @__PURE__ */ React.createElement("button", { onClick: submit, disabled: !val.trim(), className: "inv-btn inv-btn-pri" }, dlg.confirmLabel || "Guardar"))));
};
const NoticeModal = ({ dlg, onClose }) => /* @__PURE__ */ React.createElement("div", { className: "inv-modal-bg", onClick: (e) => {
  if (e.target === e.currentTarget) onClose();
} }, /* @__PURE__ */ React.createElement("div", { className: "inv-modal", role: "dialog", "aria-modal": "true", "aria-label": dlg.title || "Aviso", style: { width: 420 } }, /* @__PURE__ */ React.createElement("div", { className: "inv-modal-title" }, dlg.title || "Aviso"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-sm)", color: "var(--ink-700)", marginBottom: 18, lineHeight: 1.5 } }, dlg.msg), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end" } }, /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "inv-btn inv-btn-pri" }, "Aceptar"))));
const CAT_COLORS = {
  base: "#5A7042",
  // moss (base carbons)
  sup: "#C68F2C",
...
`;
  ...
  } }, /* @__PURE__ */ React.createElement("div", { className: "inv-modal", role: "dialog", "aria-modal": "true", "aria-label": "Nuevo proveedor" }, /* @__PURE__ */ React.createElement("div", { className: "inv-modal-title" }, "Nuevo Proveedor"), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("label", { className: "inv-label" }, "Nombre"), /* @__PURE__ */ React.createElement("input", { className: "inv-input", value: newProv.nombre, onChange: (e) => setNewProv((p) => ({ ...p, nombre: e.target.value })), placeholder: "Ej. Distribuidora Agro Sabana" })), /* @__PURE__ */ React.createElement("div", { className: "inv-row inv-row-2", style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "inv-label" }, "Tipo"), /* @__PURE__ */ React.createElement("select", { className: "inv-input", value: newProv.tipo, onChange: (e) => setNewProv((p) => ({ ...p, tipo: e.target.value })) }, [["plaza", "Plaza de mercado"], ["industrial", "Industrial"], ["artesanal", "Artesanal"], ["directo", "Directo / Finca"], ["otro", "Otro"]].map(([v, l]) => /* @__PURE__ */ React.createElement("option", { key: v, value: v }, l)))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "inv-label" }, "Municipio"), /* @__PURE__ */ React.createElement("input", { className: "inv-input", value: newProv.municipio, onChange: (e) => setNewProv((p) => ({ ...p, municipio: e.target.value })), placeholder: "Ej. Tenjo" }))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" } }, /* @__PURE__ */ React.createElement("button", { className: "inv-btn inv-btn-sec", onClick: () => setShowProvModal(false) }, "Cancelar"), /* @__PURE__ */ React.createElement("button", { className: "inv-btn inv-btn-pri", onClick: agregarProveedor }, "Guardar proveedor")))));
...
Click para editar`
  ...
  }, className: "inv-btn inv-btn-pri" }, "Guardar cosecha")))), /* @__PURE__ */ React.createElement("div", { style: { height: 40 } })), (RECETA_TABS.includes(tab) || tab === "produccion" || tab === "schedule") && /* @__PURE__ */ React.createElement("div", { "data-testid": "species-bridge", className: "species-bridge" + (bridgeHidden ? " bridge-hidden" : ""), role: "button", tabIndex: 0, "aria-expanded": bridgeOpen, style: { cursor: "pointer" }, onClick: () => setBridgeOpen((o) => !o), onKeyDown: (e) => {
    if (e.key === "Enter" || e.key === " ") {
      e.preventDefault();
      setBridgeOpen((o) => !o);
    }
  } }, /* @__PURE__ */ React.createElement("div", { className: "bridge-inner" }, !hasPickedSpecies ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "bridge-activo" }, /* @__PURE__ */ React.createElement("span", { className: "bridge-dot" }, "●"), "Sin especie"), /* @__PURE__ */ React.createElement("span", { className: "bridge-name" }, "Elige una especie para empezar"), /* @__PURE__ */ React.createElement("div", { style: { marginLeft: "auto", display: "flex", alignItems: "center", gap: 8, flexShrink: 0 } }, /* @__PURE__ */ React.createElement("select", { className: "bridge-select", value: "", onClick: (e) => e.stopPropagation(), onChange: (e) => {
