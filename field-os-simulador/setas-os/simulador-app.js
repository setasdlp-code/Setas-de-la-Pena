...
// source-hash: e8b647f708288e246b902a36d3aafb3da026fe6e686592af5a3293fd8cde256a
...
const INGS = [
  ...
  // === ECONOMÍA CIRCULAR ===
  { id: "sms", name: "Sustrato agotado (SMS)", cat: "circ", cn: 18, n: 2.5, c: 45, moisture: 70, cra: 4, ph: 6.5, dig: 6, role: "suplemento_medio", tags: ["Circular", "N alto", "Valor sin diferenciar — ver peritaje"], cost: 0, cs: ["p_ostreatus_gris", "p_ostreatus_blanco", "p_djamor_rosa"], notes: "C:N/%N/%C idénticos a pulpa de cacao — ver nota en pulpa_cacao. Costo $0 sin corregir: a diferencia de hojarasca/turba, este es un subproducto propio del ciclo de cultivo (residuo de cosechas anteriores), por lo que costo marginal $0 puede ser real — confirmar si incluye costo de transporte/manejo." },
