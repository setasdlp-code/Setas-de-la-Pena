...
// source-hash: 88bf6a6c26658fc666663ab84e6e77901149a16751241b00f402055950d110a1
...
`;
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "topbar" }, /* @__PURE__ */ React.createElement("div", { className: "topbar-mark", onClick: () => goTab("catalogo"), style: { cursor: "pointer" } }, "Setas de la Peña")), /* @__PURE__ */ React.createElement("nav", { className: "fos-rail" }, /* @__PURE__ */ React.createElement("span", { className: "fos-rail-mark", style: { position: "relative", width: 91, height: 106, display: "block" } }, /* @__PURE__ */ React.createElement("span", { style: { textAlign: "center", fontStyle: "normal", fontSize: 17, display: "block" } }, "Setas"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "var(--text-md)", lineHeight: 0.95, position: "absolute", left: 30, top: 49, fontStyle: "italic", letterSpacing: "-0.1px" } }, "de la"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, lineHeight: 1, position: "absolute", left: 27, top: 65 } }, "Peña")), NAV_GROUPS.map((g) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "home-cockpit", style: { display: "flex", flexDirection: "column", gap: 24, marginBottom: 48 } }, /* @__PURE__ */ React.createElement("div", { style: {
      ...
      }))), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper-0)", border: "1px solid var(--border-soft)", borderRadius: "var(--r-md)", padding: "18px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12, flexWrap: "wrap", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", fontWeight: 700, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: "var(--ink-500)" } }, "Tareas de hoy"), tasksHoy.length > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--ink-400)" } }, props.tasksOpenCount)), tasksHoy.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "20px", color: "var(--ink-500)", fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", border: "1px dashed var(--paper-300)", borderRadius: "var(--r-sm)" } }, "Sin tareas pendientes por ahora.") : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, tasksHoy.map((t) => /* @__PURE__ */ React.createElement("div", { key: t.key, style: { display: "flex", alignItems: "center", gap: 2, padding: "4px 12px 4px 4px", border: "1px solid var(--paper-300)", borderRadius: "var(--r-sm)", opacity: t.done ? 0.5 : 1 } }, /* @__PURE__ */ React.createElement(
        "button",
        {
    ...
    /* @__PURE__ */ React.createElement(IconFactory, { size: 12, "aria-hidden": "true" }),
    " Producción"
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React.createElement(IconMicroscope, { size: 12, "aria-hidden": "true" }),
    " Investigación"
...
Click para editar`
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "bodega-bar-right" }, /* @__PURE__ */ React.createElement("button", { className: "tog" + (usePantry ? " on" : ""), "aria-pressed": usePantry, onClick: (e) => {
    e.stopPropagation();
    ...
    return ROLE_GROUPS.map((grp) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: grp.key, className: "role-group-box", style: { marginBottom: 10, border: "1px solid var(--border-soft)", borderRadius: "var(--r-xs)", background: "var(--paper-50)", overflow: "hidden" } }, /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: { display: "inline-flex", color: "var(--ink-700)" } }, /* @__PURE__ */ React.createElement(grp.icon, { size: 16 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", fontWeight: 800, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: "var(--ink-900)" } }, grp.label, " ", /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", color: "var(--ink-600)", fontWeight: 500 } }, "(", grpIngs.length, ")")), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", color: "var(--ink-600)", lineHeight: 1.2 } }, grp.desc))),
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", background: "rgba(77,98,53,.12)", color: "var(--moss-700)", padding: "2px 5px", borderRadius: 3, fontWeight: 600 } }, compatCount, " comp."), /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: { fontSize: "var(--text-xs)", color: "var(--ink-500)", transform: isCollapsed ? "rotate(-90deg)" : "rotate(0deg)", transition: "transform .15s" } }, "▼"))
