...
function SimuladorShell(props) {
  ...
  const handleScannedValue = (raw) => {
    if (!raw) return;
    let batchId = null;
    const qrResolve = typeof window !== "undefined" ? window.SetasFieldQrResolve : null;
    if (qrResolve && typeof qrResolve.parseBatchRef === "function") {
      try {
        const parsed = qrResolve.parseBatchRef(raw);
        if (parsed && parsed.batchId) batchId = parsed.batchId;
      } catch (_) {
      }
    }
    const match = raw.match(/(?:(?:trace|c|l)\/|CAN-)?([A-Za-z0-9_-]+)/);
    const code = batchId || (match ? match[1] : raw);
    const foundLote = bitLotes.find((l) => l.codigo === code || l.id === code || batchId && (l.id === batchId || l.codigo === batchId) || raw.includes(l.codigo) || code && code.startsWith(l.codigo));
    if (foundLote) {
...
`;
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "topbar" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "topbar-mark", onClick: () => goTab("catalogo"), style: { cursor: "pointer", display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("img", { src: "_standalone_imgs/logo-sdlp.png", alt: "Setas de la Peña", width: "54", height: "28", style: { width: 54, height: "auto", maxHeight: 28, objectFit: "contain" } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 15, fontWeight: 700 } }, "Setas de la Peña"))), /* @__PURE__ */ React.createElement("nav", { className: "fos-rail" }, /* @__PURE__ */ React.createElement("span", { className: "fos-rail-mark", style: { position: "relative", width: 91, display: "flex", alignItems: "center", justifyContent: "center", padding: "12px 4px 8px" } }, /* @__PURE__ */ React.createElement("img", { src: "_standalone_imgs/logo-sdlp.png", alt: "Setas de la Peña", width: "80", height: "42", style: { width: 80, height: "auto", maxHeight: 48, objectFit: "contain", display: "block" } })), NAV_GROUPS.map((g) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "home-cockpit" }, /* @__PURE__ */ React.createElement("div", { className: "home-header-cockpit" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { minWidth: 240 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 8, height: 8, borderRadius: "50%", background: operationStatus.color, display: "inline-block" } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", fontWeight: 800, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: operationStatus.color } }, "CONTROL · TURNO ACTUAL"), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", color: "var(--ink-500)" } }, "· Tenjo · 2.592 msnm")), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--font-display)", fontWeight: 400, fontSize: "var(--text-2xl)", lineHeight: 1.1, letterSpacing: "-0.02em", color: "var(--ink-900)", margin: 0 } }, "Tablero de Control")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" } }, [
    ...
    ].map((m) => /* @__PURE__ */ React.createElement("button", { key: m.label, onClick: () => m.onClick && m.onClick(), className: "home-registro-chip", style: { cursor: "pointer", display: "inline-flex", alignItems: "baseline", gap: 5, background: "var(--paper-100)", border: "1px solid var(--paper-300)", borderRadius: "var(--r-xs)", padding: "5px 10px" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", color: "var(--ink-500)" } }, m.label), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontWeight: 700, fontSize: "var(--text-sm)", color: m.color || "var(--ink-900)" } }, m.value)))), /* @__PURE__ */ React.createElement("button", { onClick: () => props.onGoRegistro && props.onGoRegistro(), style: { cursor: "pointer", background: "none", border: "none", padding: 0, fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", fontWeight: 700, color: "var(--coral-600)", flexShrink: 0, whiteSpace: "nowrap" } }, "Ver registro completo →")), /* @__PURE__ */ React.createElement("div", { className: "home-live-telemetry", style: { marginTop: 14, paddingTop: 14, borderTop: "1px solid var(--paper-300)" } }, /* @__PURE__ */ React.createElement(LiveTelemetryStatusBar, null), /* @__PURE__ */ React.createElement(LiveAlertsSection, null), /* @__PURE__ */ React.createElement(LiveClimateStrip, null)), (props.hasHandoff === true || props.hasHandoff === "true") && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 16, paddingTop: 16, borderTop: "1px solid var(--paper-300)" } }, /* @__PURE__ */ React.createElement("div", { style: { border: "1px solid var(--slate-500)", borderRadius: "var(--r-sm)", padding: "10px 14px", background: "var(--paper-50)" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-xs)", color: "var(--slate-700)" } }, "Traspaso del turno anterior"), /* @__PURE__ */ React.createElement("button", { onClick: () => props.onClearHandoff && props.onClearHandoff(), className: "home-handoff-dismiss", style: { cursor: "pointer", background: "none", border: "none", padding: 0, fontFamily: "var(--font-body)", fontSize: "var(--text-2xs)", color: "var(--ink-500)" } }, "Leído")), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", color: "var(--ink-700)", marginTop: 4, lineHeight: 1.4 } }, props.handoffText))), criticalStockItems.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "stock-critical-card", style: { marginTop: 16, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", fontWeight: 700, textTransform: "uppercase", color: "color-mix(in oklab, var(--coral-700) 70%, black)" } }, "⚠ Alerta de Stock Crítico (", criticalStockItems.length, ")"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 } }, criticalStockItems.slice(0, 3).map(({ ing, stockKg, threshold }) => /* @__PURE__ */ React.createElement("span", { key: ing.id, style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", padding: "2px 6px", background: "var(--paper-0)", border: "1px solid var(--coral-300)", borderRadius: 2, color: "color-mix(in oklab, var(--coral-700) 70%, black)" } }, ing.name, ": ", stockKg.toFixed(1), " kg (< ", threshold, " kg)")), criticalStockItems.length > 3 && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--ink-500)", padding: "2px 4px" } }, "+", criticalStockItems.length - 3, " más"))), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => {
      setInvTab("compra");
      goTab("inventario");
    }, style: { background: "none", border: "none", color: "color-mix(in oklab, var(--coral-700) 70%, black)", fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", fontWeight: 700, textDecoration: "underline", cursor: "pointer", padding: 0 } }, "Registrar Compra +"))), /* @__PURE__ */ React.createElement("div", { className: "home-acciones-tareas-row" }, /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper-0)", border: "1px solid var(--border-soft)", borderRadius: "var(--r-md)", padding: "18px 20px", height: "100%" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-2xs)", fontWeight: 800, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: "var(--ink-500)" } }, "SECCIÓN A · OPERACIÓN INMEDIATA"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-lg)", letterSpacing: "-0.01em", color: "var(--ink-900)", marginTop: 2, marginBottom: 0 } }, "Acciones Rápidas")), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", color: "var(--ink-400)" } }, "Acceso a 1 clic")), /* @__PURE__ */ React.createElement("div", { style: {
      display: "grid",
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", flexShrink: 0, color: accent || "var(--ink-700)" } }, /* @__PURE__ */ React.createElement(btn.icon, { size: 18 })),
    ...
    }))), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper-0)", border: "1px solid var(--border-soft)", borderRadius: "var(--r-md)", padding: "18px 20px", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12, flexWrap: "wrap", gap: 8 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", fontWeight: 700, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: "var(--ink-500)" } }, "SECCIÓN A · TRABAJO DEL DÍA"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-lg)", letterSpacing: "-0.01em", color: "var(--ink-900)", marginTop: 2, marginBottom: 0 } }, "Tareas de Hoy")), tasksHoy.length > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--ink-400)" } }, props.tasksOpenCount, " pendientes")), tasksHoy.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "20px", color: "var(--ink-500)", fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", border: "1px dashed var(--paper-300)", borderRadius: "var(--r-sm)" } }, "Sin tareas pendientes por ahora.") : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, tasksHoy.slice(0, 5).map((t) => /* @__PURE__ */ React.createElement("div", { key: t.key, style: { display: "flex", alignItems: "center", gap: 2, padding: "4px 12px 4px 4px", border: "1px solid var(--paper-300)", borderRadius: "var(--r-sm)", opacity: t.done ? 0.5 : 1 } }, /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    })() : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", color: "var(--ink-500)" } }, "No hay lotes activos. Inicia un nuevo lote desde la Ficha de Producción o la Bitácora."), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowBitNuevo(true), style: { padding: "6px 14px", background: "var(--moss-700)", color: "var(--paper-0)", border: "none", borderRadius: "var(--r-xs)", fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-xs)", letterSpacing: "var(--tracking-button)", textTransform: "uppercase", cursor: "pointer" } }, "+ Iniciar Primer Lote"))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", fontWeight: 700, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: "var(--ink-500)" } }, "SECCIÓN C · AMBIENTES & SENSORES"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-lg)", letterSpacing: "-0.01em", color: "var(--ink-900)", marginTop: 2, marginBottom: 0 } }, "Cámaras de Cultivo")), /* @__PURE__ */ React.createElement("button", { onClick: () => goTab("clima"), style: { background: "none", border: "none", padding: 0, cursor: "pointer", fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--coral-600)", fontWeight: 700 } }, "Ver Cámaras & IoT (", camaras.length, ") →")), camaras.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { border: "1px dashed var(--paper-300)", borderRadius: "var(--r-md)", padding: "16px", textAlign: "center", fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", color: "var(--ink-500)" } }, "Sin datos de cámaras disponibles.") : /* @__PURE__ */ React.createElement("div", { className: "home-ambient-strip" }, camaras.map((c) => /* @__PURE__ */ React.createElement("div", { key: c.id, className: "ambient-chamber-card", style: { borderLeft: `4px solid ${c.estadoAccent || "var(--ink-500)"}` } }, /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0, flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 2 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", color: c.estadoAccent || "var(--ink-500)" } }, /* @__PURE__ */ React.createElement(IconCamera, { size: 13 })), /* @__PURE__ */ React.createElement("strong", { style: { fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-sm)", color: "var(--ink-900)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, c.name), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-micro)", fontWeight: 700, padding: "1px 5px", borderRadius: 2, background: "var(--status-active-bg)", color: "color-mix(in oklab, var(--moss-700) 75%, black)", textTransform: "uppercase" } }, c.estadoLabel)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-2xs)", color: "var(--ink-500)" } }, "Zona ", c.zona, " · ", c.sppName, " · ", c.occupancy, "% cap."), c.hasLiveAlert && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-2xs)", color: "var(--coral-700)", marginTop: 2, fontWeight: 700 } }, "⚠ ", c.liveAlertNote)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, flexShrink: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, textAlign: "center", fontFamily: "var(--font-mono)" } }, /* @__PURE__ */ React.createElement("span", { style: { background: "var(--paper-100)", border: "1px solid var(--paper-300)", borderRadius: "var(--r-xs)", padding: "4px 6px", fontSize: "var(--text-xs)", fontWeight: 700, color: "var(--ink-900)" } }, c.liveTemp, "°C"), /* @__PURE__ */ React.createElement("span", { style: { background: "var(--paper-100)", border: "1px solid var(--paper-300)", borderRadius: "var(--r-xs)", padding: "4px 6px", fontSize: "var(--text-xs)", fontWeight: 700, color: "var(--ink-900)" } }, c.liveHum, "%"), /* @__PURE__ */ React.createElement("span", { style: { background: "var(--paper-100)", border: "1px solid var(--paper-300)", borderRadius: "var(--r-xs)", padding: "4px 6px", fontSize: "var(--text-xs)", fontWeight: 700, color: "var(--ink-900)" } }, c.liveCo2, " ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: "var(--text-micro)", color: "var(--ink-500)" } }, "ppm"))), /* @__PURE__ */ React.createElement("button", { onClick: () => props.onOpenCamara && props.onOpenCamara(c.id), title: "Abrir detalle de cámara", style: { cursor: "pointer", background: "none", border: "none", padding: 4, color: "var(--ink-400)", display: "grid", placeItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-sm)", fontWeight: 700, color: "var(--coral-600)" } }, "→"))))))), recentActivity.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-2xs)", fontWeight: 700, letterSpacing: "var(--tracking-button)", textTransform: "uppercase", color: "var(--ink-500)" } }, "SECCIÓN D · SEGUIMIENTO DEL DÍA"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-body)", fontWeight: 800, fontSize: "var(--text-lg)", letterSpacing: "-0.01em", color: "var(--ink-900)", marginTop: 2, marginBottom: 0 } }, "Actividad Reciente"))), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper-0)", border: "1px solid var(--border-soft)", borderRadius: "var(--r-md)", padding: "18px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column" } }, recentActivity.map((ev, i) => /* @__PURE__ */ React.createElement("button", { key: i, onClick: () => props.onActivityGo && props.onActivityGo(ev.container, ev.type), className: "home-activity-row", style: { cursor: "pointer", display: "flex", gap: 12, padding: "11px 4px", borderTop: "none", borderLeft: "none", borderRight: "none", borderBottom: i < recentActivity.length - 1 ? "1px solid var(--paper-300)" : "none", background: "none", width: "100%", textAlign: "left", borderRadius: "var(--r-xs)" } }, /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, width: 8, height: 8, borderRadius: "50%", background: ev.accent, marginTop: 6 } }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-body)", fontWeight: 700, fontSize: "var(--text-sm)", color: "var(--ink-900)" } }, ev.typeLabel), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--slate-600)" } }, ev.container)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", color: "var(--ink-600)", marginTop: 1 } }, ev.note)), /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, alignSelf: "center", fontFamily: "var(--font-mono)", fontSize: "var(--text-sm)", color: "var(--ink-400)", fontWeight: 700 } }, "→")))))));
  })(), tab === "catalogo" && (() => {
    const recipesBySpp = {};
    saved.forEach((e) => {
    ...
    })), focusSpp && /* @__PURE__ */ React.createElement("div", { className: "recetario-ficha" }, IMG[focusKey] && /* @__PURE__ */ React.createElement("div", { className: "recetario-ficha-img" }, /* @__PURE__ */ React.createElement("img", { src: IMG[focusKey], alt: focusSpp.name, width: "200", height: "150", loading: "lazy", decoding: "async" })), /* @__PURE__ */ React.createElement("div", { className: "recetario-ficha-body" }, /* @__PURE__ */ React.createElement("div", { className: "recetario-ficha-sci" }, focusSpp.scientific), /* @__PURE__ */ React.createElement("p", { className: "recetario-ficha-note" }, focusSpp.notes.split(".")[0] + "."), /* @__PURE__ */ React.createElement("div", { className: "recetario-ficha-params" }, [
