...
// source-hash: 9fd348d9163c37bf232d1e0e913504814d59df1c780cd1b3f3c5f94f8d081430
...
`;
  ...
  )), tab === "formular" && builderSubTab === "formular" && recipe.length > 0 && /* @__PURE__ */ React.createElement("section", { className: `form-production-command is-${formNextState}`, "aria-label": "Siguiente paso de producción" }, /* @__PURE__ */ React.createElement("div", { className: "form-production-command-copy" }, /* @__PURE__ */ React.createElement("span", null, "Ruta de producción"), /* @__PURE__ */ React.createElement("strong", null, formNextState === "species" ? "Falta definir la especie" : formNextState === "balance" ? "Falta cerrar el balance" : "Receta lista para preparar")), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
