                                ...
                                {items.map(({lote:lt,stats,age,colonizado})=>{
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <div style={{marginTop:2,height:2,background:'var(--paper-2)',borderRadius:0}}>
                                        <div style={{width: colonizado ? '100%' : '65%',height:'100%',background:critical?'var(--accent-terracotta)':contaminated?'var(--accent-terracotta)':'var(--accent-olive)'}}></div>
                                      </div>
