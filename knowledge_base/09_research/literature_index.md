...
<!-- CHANGELOG: 2026-07-04 — Registrada fuente paper_006 (Cenicafé/FNC 2005) sobre cultivo de L. edodes y G. lucidum en subproductos de café. Ver literature_database.md para entrada completa. -->
<!-- CHANGELOG: 2026-07-04 — Incorporados 5 PDFs subidos por el usuario: book_006 (Genetics and Breeding of Edible Mushrooms, Chang/Buswell/Miles 1993), book_007 (Mushrooms: Cultivation, Nutritional Value, Medicinal Effect and Environmental Impact, Chang & Miles 2004 — antes en "literatura pendiente"), guide_002 (ICAR-DMR 2020, Growing Oyster Mushroom), guide_003 (MushWorld 2004, Oyster Mushroom Cultivation Handbook), guide_004 (UNAPCAEM/Chang ca. 2010, Training Manual). Ver literature_database.md para entradas completas. -->


# Executive Summary
Índice rápido de toda la literatura técnica disponible en la base de conocimiento. Para contenido completo de cada fuente, ver `literature_database.md`.

# Literature Index

## Papers Científicos

| ID | Autores | Año | Título (Abreviado) | Especie | Relevancia |
|---|---|---|---|---|---|
| paper_001 | Zurbano, Bellere & Savilla | 2017 | P. djamor en formulaciones basadas en paja de arroz | P. djamor | ★★★☆☆ |
| paper_002 | Mori et al. | 2008 | NGF-inducing activity in vitro / preclínica | H. erinaceus | ★★★☆☆ |
| paper_003 | Friedman | 2015 | Chemistry & health properties of H. erinaceus | H. erinaceus | ★★★★★ |
| paper_004 | Stamets | 2000 | P. djamor cultivation parameters | P. djamor | ★★★★★ |
...
| ID | Autor | Año | Título | Cobertura |
|---|---|---|---|---|
| book_001 | Stamets, P. | 2000 | Growing Gourmet and Medicinal Mushrooms | Multi-especie, completo |
| book_002 | Cotter, T. | 2014 | Organic Mushroom Farming and Mycoremediation | Producción orgánica |
| book_003 | Zied & Pardo-Giménez | 2017 | Edible and Medicinal Mushrooms — Technology | Ciencia + comercial |
| book_004 | Stamets, P. | 2005 | Mycelium Running | Medicinal, ecología |
| book_005 | Piepenbring, M. | 2015 | Introducción a la Micología en los Trópicos | Referencia académica — taxonomía, biología, identificación (no cultivo) |
| book_006 | Chang, Buswell & Miles (eds.) | 1993 | Genetics and Breeding of Edible Mushrooms | Genética/reproducción de Basidiomycetes, hibridación, protoplastos — base científica para spawn propio (Fase 3) |
| book_007 | Chang, S.-T. & Miles, P.G. | 2004 | Mushrooms: Cultivation, Nutritional Value, Medicinal Effect, and Environmental Impact (2ª ed.) | Cobertura integral por género (cap. dedicados a Pleurotus, Lentinula, Ganoderma); BE, sustrato, ambiente por especie |

## Manuales / Guías Técnicas

| ID | Autores | Año | Título (Abreviado) | Cobertura | Relevancia |
|---|---|---|---|---|---|
| guide_001 | Grassi, Álvarez & Restelli (IMiBio) | 2019 | Guía para la producción de hongos comestibles | Diseño de planta, IPM, producción continua (P. ostreatus) | ★★★☆☆ |
...
| ID | Dominio | Título | Relevancia |
|---|---|---|---|
| web_001 | zombiemyco.com | Humidity in Mushroom Cultivation | Dew point / HR real |
| web_002 | coloradoculturesllc.com | Why Humidity and Airflow Matter | HR + FAE + dew point |
| web_003 | blog.mycology.cornell.edu | Cornell Mushroom Blog | Biología, recursos académicos |
| web_004 | shroomery.org | Shroomery | Comunidad — validar antes de usar |

## Clasificación por Especie

### Pleurotus djamor
- paper_001 (★★★☆☆) — Formulaciones tropicales basadas en paja de arroz; BE máxima 31,1%; no estudia FAE
- paper_004 (★★★★★) — Parámetros cultivo (Stamets)
- guide_002 (★★★★★) — Protocolo cuantificado ICAR: spawn 3%/10%, cultivo madre 25±2°C/pH 7, BE 80–100%
- guide_003 (★★★★☆) — Tabla ambiental (cita Stamets 1993), confirma T°/HR/CO₂/luz
- book_001 (★★★★☆) — Protocolo completo
- book_007 (★★★★★) — Cap. 16 Pleurotus — CO₂ tolerancia micelial vs. umbral fructificación, BE por especie
