...
# Core Principles
- Pasteurización suficiente para Pleurotus en paja; esterilización necesaria para sustratos suplementados.
- La Field Capacity (FC) del sustrato al inocular es crítica: demasiado húmedo → bacteria; muy seco → micelio no crece.
- Compatible ≠ óptimo: usar el sustrato más accesible y económico que esté en el rango de BE aceptable.

# Technical Details

## Tabla de Sustratos por Especie

| Sustrato | P. djamor | P. ostreatus | L. edodes | H. erinaceus | G. lucidum |
|---|---|---|---|---|---|
| Paja de trigo | ★★★★★ | ★★★★★ | ★★ | ★ | ★ |
| Master's Mix (50/50) | ★★★★ | ★★★★ | ★★★★★ | ★★★★★ | ★★★★ |
...
| Pulpa de café (en mezcla, ≤15%) | ? | ? | ★★ | ★★ | ★★ |
| Aserrín de tallo de café | ? | ? | ★★ | ? | ★★ |

★★★★★ = Óptimo / ★★★ = Adecuado / ★ = No recomendado / ? = sin dato para esa especie
...
### Bagazo de Caña
- **Composición:** Celulosa ~45%, hemicelulosa ~25%, lignina ~20%
...
### Paja de Arroz
- **Composición:** Similar a trigo (mayor contenido silíceo)
- **Disponibilidad Colombia:** Alta en zonas arroceras
- **Tratamiento:** Pasteurización
- **BE esperada:** 70–100%
- **Riesgos:** Similar a trigo; humedad inicial más difícil de calibrar

### Subproductos de Café (borra, pulpa, aserrín de tallo) — Colombia
*Fuente: Rodríguez Valencia & Jaramillo López 2005 (Cenicafé/FNC — paper_006). Solo para L. edodes y G. lucidum.*

- **Materias primas y C/N:** pulpa 31 · borra 33 · aserrín de tallo de café 47 · salvado de trigo 21 · salvado de maíz 34.
- **Relación C/N objetivo de la mezcla:** ≈40 (shiitake) · 40–60 (ganoderma).
...
## Field Capacity (FC) — Prueba Estándar

**Test:** Tomar puñado de sustrato ya humedecido y comprimir fuertemente.
- **FC correcta (~65%):** Solo escurren algunas gotas al exprimir fuerte.
- **Demasiado húmedo (>70%):** Escurre agua libremente — riesgo bacterias.
...
|---|---|---|
| Contaminación masiva en Master's Mix | Pasteurización en vez de esterilización | Esterilizar a 121°C |
| Micelio no crece | Sustrato muy húmedo (bacteria) o muy seco | Calibrar FC antes de inocular |
| BE baja en paja | Pasteurización insuficiente (Trichoderma) | Verificar temperatura y duración |
