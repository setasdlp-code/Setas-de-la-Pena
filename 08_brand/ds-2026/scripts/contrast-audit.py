...
PAIRS = [
    ...
    ("RULE", "PAPER", "Hairline border (--border-hairline, non-text)", 3.0, ALLOW),
    ("RULE", "PAPER_PANEL", "Hairline border on panels (non-text)", 3.0, ALLOW),
    ...
    ("MOSS_500", "PAPER", "Moss 500 as small text (marker only)", 4.5, FORBID),
